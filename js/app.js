...
class UI {
    insertarPresupuesto(cantidad){
        // Deconstruyendo el objeto y obteniendo el presupuesto y el restante
        const {presupuesto,restante} = cantidad;

        // Insertandolos en el HTML
    ...
    imprimirAlerta(mensaje, tipo){
        ...
        divMensaje.classList.add("text-center", `${tipo}`, "alert")
...
function agregarGasto(e){
    ...
    if(nombre === "" || cantidad === ""){
        ...
        ui.imprimirAlerta("Cantidad no valida", "alert-danger");
        return;
    }
